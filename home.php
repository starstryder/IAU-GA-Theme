...
<?php define( 'WP_USE_THEMES', false ); get_header(); ?>
        ...
        <div id="post" style="height: 2600px; width=760;">

            <!---- Sections: Around IAU ------------------------------------------------>
            <div class="Around">
                <h1>Around the GA</h1>
                <?php
                $get_AroundIAU = new WP_Query( 'cat=1,-9&posts_per_page=3' );
                ...
                <h1>Around Vienna</h1>
                <?php
                $get_AroundVienna = new WP_Query(  'cat=7,-9&posts_per_page=3'  );
            ...
            <div id="right-sidebar" style="float:right; max-width:90px;">
                ...
                <div id="photos" style="float:right;">
                    <h1>Photo Stories</h1>
                    <?php
                    $get_photos = new WP_Query( 'category_name=photo&posts_per_page=8' );
